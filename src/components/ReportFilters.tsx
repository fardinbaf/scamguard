...
const ReportFilters: React.FC<ReportFiltersProps> = ({ filters, onFilterChange, onResetFilters, isAdmin }) => {
  return (
    <div className="bg-white p-4 rounded-lg shadow mb-6">
      <div className={`grid grid-cols-1 md:grid-cols-2 gap-4 items-end ${isAdmin ? 'lg:grid-cols-4' : 'lg:grid-cols-3'}`}>
        <div>
        ...
        {isAdmin && (
         ...
         <div className="md:col-span-2 lg:col-span-1 flex justify-end mt-2 md:mt-0">
          <button 
            onClick={onResetFilters}
            className="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition-colors text-sm w-full"
          >
            Reset Filters
          </button>
        </div>
