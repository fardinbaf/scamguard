...
import AdminAdvertisementPage from './pages/AdminAdvertisementPage'; // Import AdminAdvertisementPage
...
const AppContent: React.FC = () => {
  ...
  const handleReportSubmitted = (newReport: Report) => {
    ...
    // HomePage and AdminDashboardPage handle their own refreshes.
  };
        ...
        <Routes>
          ...
          {isAdmin && (
            <>
              ...
              <Route path="/admin/advertisement" element={<AdminAdvertisementPage />} /> {/* Add route for ad management */}
            </>
          )}
